...
export class PrivacyPage extends TiniComponent {
  protected template = html`<h2>Privacy Policy</h2>

    <p>
      At TiniJS Homepage, accessible from https://tinijs.dev, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by TiniJS Hompage and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in TiniJS Homepage. This policy is not applicable to any
    ...
    <p>
      TiniJS Homepage follows a standard procedure of using log files. These
    ...
    <p>
      ...
      advertising partners of TiniJS Homepage.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on TiniJS Homepage, which are sent
    ...
    <p>
      Note that TiniJS Homepage has no access to or control over these cookies
    ...
    <p>
      TiniJS Homepage's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      TiniJS Homepage does not knowingly collect any Personal Identifiable
